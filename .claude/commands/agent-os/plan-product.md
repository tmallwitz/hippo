---
name: plan-product
description: Establish foundational product documentation through an interactive conversation. Creates or updates mission.md, roadmap.md, and tech-stack.md in agent-os/product/ based on product vision, target users, roadmap phases, and tech stack.
effort: high
---
# Plan Product
