...
- **FastAPI HTTPException**: Use `HTTPException` for API error responses with appropriate status codes
- **Structured Error Logging**: Log exceptions with Structlog including context (request_id, user, etc.)
